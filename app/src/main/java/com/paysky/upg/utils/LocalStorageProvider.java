...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    /**
     * Default DocumentsContract.Root projection: everything but DocumentsContract.Root.COLUMN_MIME_TYPES
     */
    ...
    /**
     * Default DocumentsContract.Document projection: everything but DocumentsContract.Document.COLUMN_ICON and
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.blue_bg_with_redius);
        // These columns are optional
        row.add(DocumentsContract.Root.COLUMN_AVAILABLE_BYTES, homeDir.getFreeSpace());
        // DocumentsContract.Root.COLUMN_MIME_TYPE is another optional column and useful if you
    ...
    private void includeFile(final MatrixCursor result, final File file)
        ...
        // DocumentsContract.Document.COLUMN_ICON can be a resource id identifying a custom icon.
        // The system provides default icons
        // based on mime type
        // DocumentsContract.Document.COLUMN_SUMMARY is optional additional information about the
        // file
    }
